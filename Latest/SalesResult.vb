...
#End Region
    Private Sub ProductList()
        ...
        Catch ex As Exception
            ...
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SalesResult", "SalesResult", "Sub", "ProductLIst()", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Private Sub GetData()
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SalesResult", "SalesResult", "Sub", "GetData()", "0", ex.Message.ToString)
            y = Nothing
        End Try
...
#End Region
    ...
    Private Sub SaleDetail()
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SalesResult", "SalesResult", "Sub", "SaleDetail()", "0", ex.Message.ToString)
            y = Nothing
        End Try
             ...
             Me.cboSalesResults.Text = "Demo/No Sale" Or Me.cboSalesResults.Text = "Sale" Or Me.cboSalesResults.Text = "No Demo") Then
                Dim x = MsgBox("The System is not requiring a sale result for this record. You can" & vbCr & _
                       ...
                       "that it can affect reporting accuracy. Alternatively, You can Set an" & vbCr & _
                        ...
                        "Would you like to ignore this Warning and enter this result anyway?" & vbCr & "(Not Recommended)", MsgBoxStyle.YesNo, "Result Not Required")
                If x = vbNo Then
                    Me.cboSalesResults.Text = Nothing
                    Exit Sub
                End If
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            ElseIf Me.cboSalesResults.Text = "Bank Approved" Then
                description = "Contract has been approved by the Finance Department. Approval logged by " & STATIC_VARIABLES.CurrentUser & ". (Forwarded to the Installation Department)"
        ...
        Catch ex As Exception
            ...
            Main.Cursor = Cursors.Default
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SalesResult", "FormCode", "Sub", "btnSave_Click", Me.ID, ex.Message.ToString)
            y = Nothing
        End Try
    End Sub
