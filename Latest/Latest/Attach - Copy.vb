...
Public Class Attach2
    Private cnn As SqlConnection = New SqlConnection("Data Source=EKG1\SQLEXPRESS;Initial Catalog=iss;Persist Security Info=True;User ID=Clay;Password=spoken1")
