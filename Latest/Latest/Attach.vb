...
Public Class Attach
    ...
    Private Sub LogToSQLFileMove(ByVal ID As String, ByVal SourcePath As String, ByVal ServerDestination As String)
        Dim cnx_MOVE As SqlConnection = New SqlConnection("SERVER=192.168.1.2;Database=ISS;User Id=sa;Password=spoken1")
        cnx_MOVE.Open()
    ...
    Private Function CountDuplicates(ByVal ID As String, ByVal SourcePath As String, ByVal ServerPath As String)
        ...
        Dim cmd_DUP As SqlConnection = New SqlConnection("SERVER=192.168.1.2;Database=ISS;User Id=sa;Password=spoken1")
        cmd_DUP.Open()
