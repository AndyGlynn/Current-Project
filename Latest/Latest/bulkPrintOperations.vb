...
#End Region
    ...
    Public Sub DoTheWork(ByVal LeadNum As String)
        ...
        frmPrint.wbPrint.Navigate(local_test_directory_print & LeadNum.ToString & ".htm")
    ...
    Public Sub GenerateBoiler_Exclusions(ByVal MSG_BODY As MessageBody, ByVal LeadNum As String, ByVal Exclusions As Exclusions)
        ...
        Dim fn_nfo As New System.IO.FileInfo(local_test_directory_print & "\" & LeadNum.ToString & ".htm")
        Dim fs As StreamWriter
        If fn_nfo.Exists = True Then
            System.IO.File.Delete(local_test_directory_print & "\" & LeadNum.ToString & ".htm")
            fs = New StreamWriter(local_test_directory_print & "\" & LeadNum.ToString & ".htm")
    ...
    Public Sub GenerateBULK_PRINT(ByVal StrMSG As String)
        ...
        Dim fn_nfo As New System.IO.FileInfo(local_test_directory_print & "\BULK_PRINT.htm")
        Dim fs As StreamWriter
        If fn_nfo.Exists = True Then
            System.IO.File.Delete(local_test_directory_print & "\BULK_PRINT.htm")
            fs = New StreamWriter(local_test_directory_print & "\BULK_PRINT.htm")
        ElseIf fn_nfo.Exists = False Then
            fs = New StreamWriter(local_test_directory_print & "\BULK_PRINT.htm")
        End If
        fs.Write(StrMSG)
        fs.Flush()
        fs.Close()
        frmPrint.wbPrint.Navigate(local_test_directory_print & "BULK_PRINT.htm")
    End Sub
