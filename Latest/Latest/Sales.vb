...
#Region "My Procedures"
    Private Sub ButtonConfig()
        ...
        Me.btnEmailIssue.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.btnEmailAllIssue, Me.btnEmailThisIssue, Me.btnEmailIssuedAppts})
    ...
    Private Sub LoadReps()
        ...
        Dim cnn1 As SqlConnection = New SqlConnection("Data Source=192.168.1.2;Initial Catalog=iss;User Id=sa;Password=spoken1")
...
#End Region
    ...
    End Sub
    Dim dtpsum1orig As String = Me.dtpSummary.Value.ToString
    Dim dtpsum2orig As String = Me.dtpSummary2.Value.ToString
    ...
    Private Sub dtpSummary_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtpSummary.GotFocus
        If dtpsum1orig <> Me.dtpSummary.Value.ToString Then
            Me.cboDateRangeSummary.Text = "Custom"
        End If
    ...
    Private Sub EmailThisLeadToAssignedRepsToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles EmailThisLeadToAssignedRepsToolStripMenuItem.Click
        MsgBox("Email this lead to assigned reps")
    End Sub
    ...
    Private Sub Sales_MaximumSizeChanged(sender As Object, e As EventArgs) Handles Me.MaximumSizeChanged
        MsgBox("resize end")
    End Sub

    Private Sub Sales_MouseEnter(sender As Object, e As EventArgs) Handles Me.MouseEnter

    End Sub

    Private Sub Sales_ResizeBegin(sender As Object, e As EventArgs) Handles Me.ResizeBegin

    End Sub

    Private Sub Sales_ResizeEnd(sender As Object, e As EventArgs) Handles Me.ResizeEnd
