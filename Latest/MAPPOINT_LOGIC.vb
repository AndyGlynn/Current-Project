...
Public Class MAPPOINT_LOGIC
    ...
    '' 
    '' WRONG. 2-11-2016
    '' This code is explicity used by WCaller Form
    '' and more importantly is the legacy code for 'radius search' feature.
    '' however, it is broken and needs to be re-done.
    '' causes form to 'hang/lock' up 
    '' nested error handlers and will look closer at it.
    '' 
