...
Public Class SetUpUser1
    ...
    Private Sub SetUpUser1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            ...
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SetUpUser1", "FormCode", "Event", "SetUpUser1_load", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SetUpUser1", "FormCode", "Event", "btnSave_Click", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Private Sub chkCanEmail_CheckStateChanged(sender As Object, e As EventArgs) Handles chkCanEmail.CheckStateChanged
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SetUpUser1", "FormCode", "Event", "chkCanEmail_CheckStateChanged", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Public Function CapitalizeText(ByVal TextToCap As String)
        ...
        Catch ex As Exception
            ...
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SetUpUser1", "FormCode", "Event", "CapitalizeText(texttocap)", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Private Sub txtUserName_LostFocus(sender As Object, e As EventArgs) Handles txtUserName.LostFocus
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "SetUpUser1", "FormCode", "Event", "txtUserName_lostFocus", "0", ex.Message.ToString)
            y = Nothing
        End Try
