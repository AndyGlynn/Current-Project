...
#Region "Whole Form Events"
    ...
    Private Sub SalesDepartment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnExpandSalesList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#Region "Summary Page Events"
    ...
    Private Sub lvnoresults_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.lvnoresults.SelectedItems.Count = 0 Then
            Exit Sub
        End If
    ...
    End Sub
    Private Sub lvnoresults_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.lvnoresults.SelectedItems.Count = 0 Then
            Me.ID = ""
            STATIC_VARIABLES.CurrentID = Me.ID
            Exit Sub
...
#Region "Date Range Controls"
    ...
    End Sub
    Private Sub tmrSum_Tick(sender As Object, e As EventArgs)
        If Me.cboDateRangeSummary.Text = "Custom" Then
    ...
    End Sub
    Private Sub tmrdtpCustList_Tick(sender As Object, e As EventArgs)
...
#Region "Customer List Controls"
    ...
    Private Sub lblGroupBy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.cboGroupSales.Focus()
        Me.cboGroupSales.DroppedDown = True
    End Sub
    Private Sub cboGroupSales_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub LinkLabel2_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
        ...
        End If
    End Sub
    Private Sub cboSalesList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
...
#Region "LV Sales Virutal Mode "
    ...
    Private Sub lvSales_MouseClick(sender As Object, e As MouseEventArgs)
        Try
            If current_Item IsNot Nothing Then
                PullInfo(current_Item.Text)
        ...
        Catch ex As Exception
            ...
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "Sales", "FormCode", "Event", "lvSales_MouseClick", "0", ex.Message.ToString)
            y = Nothing
        End Try
    End Sub
...
#Region "Customer Log & Attached Files"
    ...
    Private Sub tsbtnAFPics_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub tsbtnShowCH_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Me.tsCustomerLog.Visible = True
            Me.tsAFPics.Visible = False
            Me.pnlCustomerHistory.Visible = True
    ...
    Private Sub tscboAFPicsFilter_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnCandC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#Region "Memorized Controls"
    ...
    Private Sub lvMemorized_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub lvMemorized_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Me.TT = New ToolTip
            Me.IfExists = True
    ...
    Private Sub lvMemorized_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        Me.xcordinate = e.X
        Me.ycordinate = e.Y
    End Sub
    Public Sub lvMemorized_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.lvMemorized.SelectedItems.Count <> 0 Then
...
#End Region
    ...
    Private Sub btnSaveRep_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveRep.Click
        ...
        Catch ex As Exception
            Dim y As New ErrorLogging_V2
            y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "Sales", "FormCode", "Event", "btnSaveRep_Click", "0", ex.Message.ToString)
            y = Nothing
        End Try
    ...
    Private Sub lblFilterGroups_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.cboFilterGroups.Focus()
        Me.cboFilterGroups.DroppedDown = True
    End Sub

    Private Sub cboFilterGroups_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub cboGroupByMemorized_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.cboGroupByMemorized.Text <> "" Then
    ...
    Private Sub lblgroupbymemorized_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.cboGroupByMemorized.Focus()
        Me.cboGroupByMemorized.DroppedDown = True
    End Sub

    Private Sub TabControl2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.TabControl2.SelectedIndex = 0 Then
            Me.ToolbarConfig(2)
            If Me.lvSales.SelectedItems.Count = 0 Then
                Me.PullInfo("")
    ...
    Private Sub btnExpandMemorize_Click(ByVal sender As Object, ByVal e As System.EventArgs)

        Me.btnExpandSalesList_Click(Nothing, Nothing)

    End Sub

    Private Sub lbldisplaymemorized_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub cboDisplayMemorized_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub lnkOrderbyMem_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
    ...
    Private Sub ShowNotesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.lvMemorized_DoubleClick(Nothing, Nothing)
    End Sub

    Private Sub EnterSalesResultToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnSalesResult2_ButtonClick(Me.btnSalesResult2, Nothing)
    End Sub

    Private Sub MemorizeThisApptToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnMemorize_Click(Nothing, Nothing)
    End Sub

    Private Sub RemoveThisApptToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnMemorize_Click(Nothing, Nothing)
    End Sub

    Private Sub CustomerToolsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub SetAppointmentToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub SaveChangesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ToolStripComboBox2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
 ...
 Dim x As New SubForm_Launcher(sender)
    ...
    Private Sub MarkTaskAsDoneToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.btnMarkTaskAsDone_Click(Nothing, Nothing)
    End Sub

    Private Sub EditScheduledTaskToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub HideThisCompletedTaskToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.btnRemoveThisCompletedTask_Click(Nothing, Nothing)
    End Sub

    Private Sub pnlScheduledTasks_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
    ...
    Private Sub tsSalesDepartment_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub SCsalesresult_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.btnSalesResult_Click1(Me.btnSalesResult, Nothing)
    End Sub

    Private Sub SCCustomerList_Click(ByVal sender As Object, ByVal e As System.EventArgs)
...
#Region "Context Menu - OPEN - LS and JP"
    Private Sub btnOpen_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If sel_Item_right IsNot Nothing Then
            ...
            Catch ex As Exception
                Dim y As New ErrorLogging_V2
                y.WriteToLog(Date.Now, My.Computer.Name, STATIC_VARIABLES.IP, "Sales", "FormCode", "Sub", "btnOpen_Click", "0", ex.Message.ToString)
                y = Nothing
            End Try
...
#Region "Delete Context Menus - LS and JP"
    ...
    End Sub
    Private Sub btnDeleteJP_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            If sel_Item_Right_Jp IsNot Nothing Then
...
#Region "Rename Context Menu - LS and JP"
    Private Sub btnRename_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            If sel_Item_right IsNot Nothing Then
    ...
    Private Sub btnRenameJP_Click(sender As Object, e As EventArgs)
        Try
            If sel_Item_Right_Jp IsNot Nothing Then
...
#Region "Context Menu Cut - LS and JP "
    ...
    Private Sub btnCutJP_Click(sender As Object, e As EventArgs)
        If sel_Item_Right_Jp IsNot Nothing Then
...
#Region "Copy Context Menu - LS and JP"
    ...
    Private Sub btnCopyJP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If sel_Item_Right_Jp IsNot Nothing Then
...
#Region "List View Sorts - LS and JP"
    Private Sub btnAscending_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
    ...
    End Sub
    Private Sub btnAscendingJP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Dim y As New ListSortAscending
    ...
    Private Sub btnDesc_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
    ...
    End Sub
    Private Sub btnDescending_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Dim z As New ListSortDescending
...
#Region "List View - {views} Attached Files"
    ...
    Private Sub btnXLarge_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnLarge_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnMedium_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnXLarge.Checked = False
        Me.btnLarge.Checked = False
    ...
    Private Sub btnSmall_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnXLarge.Checked = False
        Me.btnLarge.Checked = False
        Me.btnMedium.Checked = False
    ...
    Private Sub btnTiles_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.btnXLarge.Checked = False
        Me.btnLarge.Checked = False
        Me.btnMedium.Checked = False
        Me.btnSmall.Checked = False
...
#Region "Context Menu New Folder - LS and JP"
    Private Sub btnNewFolder_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Dim cur_Dir As String = Me.lsAttachedFiles.Tag
            If Len(cur_Dir) <= 0 Then
                cur_Dir = (af_dir & STATIC_VARIABLES.CurrentID)
    ...
    End Sub
    Private Sub btnNewFolderJP_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Dim cur_Dir As String = Me.lsJobPictures.Tag
            If Len(cur_Dir) <= 0 Then
                cur_Dir = (jp_dir & STATIC_VARIABLES.CurrentID)
...
#End Region
    ...
    Private Sub EditCustomerToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub pnlIssue_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub pnlScheduledTasks_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs)

    End Sub

    Private Sub pnlIssue_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
    ...
    Private Sub pnlPerformanceReport_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub PrintThisLeadToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        btnPrintThisIssue_Click(sender, e)
    End Sub

    Private Sub EmailThisLeadToAssignedRepsToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub Sales_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'Me.Label4.Location = New System.Drawing.Point((Me.tpSummary.Width / 2) - 87, Me.Label4.Location.Y)
        Try
            If Me.lvSales.SelectedItems.Count <> 0 Then
                'Dim c As New CustomerHistory
    ...
    Private Sub tpSummary_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
...
#End Region
    ...
    Private Sub tsAttachedFilesNAV_Click(sender As Object, e As EventArgs)
        Try
            Dim x As Control
...
#End Region
    ...
    Private Sub bgGetImages_DoWork(sender As Object, e As ComponentModel.DoWorkEventArgs)
        GetImages_Files_And_Folders(STATIC_VARIABLES.CurrentID)
    End Sub

#Region "List View - {Views} Job Pictures"
    Private Sub cmJPExtraLarge_Click(sender As Object, e As EventArgs)
    ...
    Private Sub cmJPLarge_Click(sender As Object, e As EventArgs)
    ...
    Private Sub cmJPMedium_Click(sender As Object, e As EventArgs)
        Me.cmJPExtraLarge.Checked = False
        Me.lsJobPictures.View = View.LargeIcon
    ...
    Private Sub cmJPSmall_Click(sender As Object, e As EventArgs)
        Me.cmJPExtraLarge.Checked = False
    ...
    Private Sub cmJPList_Click(sender As Object, e As EventArgs)
        Me.cmJPExtraLarge.Checked = False
    ...
    Private Sub cmJPDetails_Click(sender As Object, e As EventArgs)
        Me.cmJPExtraLarge.Checked = False
    ...
    Private Sub cmJPTiles_Click(sender As Object, e As EventArgs)
        Me.cmJPExtraLarge.Checked = False
...
#Region "ls attached files / job pictures - selection logic "
    ...
    Private Sub lsAttachedFiles_AfterLabelEdit(sender As Object, e As LabelEditEventArgs)

    End Sub

    Private Sub lsJobPictures_AfterLabelEdit(sender As Object, e As LabelEditEventArgs)

    End Sub

    Private Sub lsAttachedFiles_BeforeLabelEdit(sender As Object, e As LabelEditEventArgs)
        ''
    ...
    Private Sub lsJobPictures_BeforeLabelEdit(sender As Object, e As LabelEditEventArgs)
        ''
        '' before label edit -> name of listviewItem -> store it locally
        ''
        Dim ls As ListView = sender
    ...
    Private Sub lsAttachedFiles_MouseUp(sender As Object, e As MouseEventArgs)
        Dim ls As ListView = sender
    ...
    Private Sub lsJobPictures_MouseUp(sender As Object, e As MouseEventArgs)
        Dim ls As ListView = sender
        Select Case e.Button
            Case Windows.Forms.MouseButtons.Left
    ...
    Private Sub lsAttachedFiles_ItemDrag(sender As Object, e As ItemDragEventArgs)
    ...
    Private Sub lsJobPictures_ItemDrag(sender As Object, e As ItemDragEventArgs)
        If e.Item IsNot Nothing Then
            sel_item_left_DandD = e.Item
    ...
    Private Sub lsAttachedFiles_MouseDoubleClick(sender As Object, e As MouseEventArgs)
        ''
    ...
    Private Sub lsJobPictures_MouseDoubleClick(sender As Object, e As MouseEventArgs)
        ''
        '' if its a file: open it
        '' if its a folder: change the directory on the list view control to it.
        '' 
...
#Region "Create ShortCuts From Context Menus - LS and JP"
    Private Sub btnSendtoDesktop_Click(sender As Object, e As EventArgs)
        If sel_Item_right IsNot Nothing Then
    ...
    Private Sub btnSendtoDesktopJP_Click(sender As Object, e As EventArgs)
        If sel_Item_Right_Jp IsNot Nothing Then
...
#Region "Create Shortcut Context Menu - LS and JP"
    Private Sub btnCreateSC_Click(sender As Object, e As EventArgs)
        If sel_Item_right IsNot Nothing Then
            Dim whereToCreate As String = lsAttachedFiles.Tag
            If Len(whereToCreate) <= 0 Then
                whereToCreate = (af_dir & STATIC_VARIABLES.CurrentID & "\")
    ...
    Private Sub btnCreateSCJP_Click(sender As Object, e As EventArgs)
        If sel_Item_Right_Jp IsNot Nothing Then
            Dim whereToCreate As String = lsJobPictures.Tag
            If Len(whereToCreate) <= 0 Then
                whereToCreate = (jp_dir & STATIC_VARIABLES.CurrentID & "\")
...
#Region "Context Menu Refresh - LS and JP"
    ...
    Public Sub btnRefreshJP_Click(ByVal sender As Object, e As EventArgs)
        Try
            Me.Cursor = Cursors.WaitCursor
            sel_Item_Left_Jp = Nothing
            sel_Item_Right_Jp = Nothing
...
#Region "Context Menu Paste - LS and JP"
    ...
    Private Sub btnPasteJP_Click(sender As Object, e As EventArgs)
        Try
            Dim itemToCCP As String = My.Computer.Clipboard.GetText(TextDataFormat.Text)
            If Len(itemToCCP) <= 0 Then
                '' nothng here
...
#End Region
    ...
    Private Sub btnUpdateSPI_Click(sender As Object, e As EventArgs)

        Dim x As New SubForm_Launcher(sender)
    End Sub

    Private Sub bgSalesQuery_DoWork(sender As Object, e As ComponentModel.DoWorkEventArgs)
        Try
    ...
    Private Sub bgSalesQuery_RunWorkerCompleted(sender As Object, e As ComponentModel.RunWorkerCompletedEventArgs)
        Try
    ...
    Private Sub bgCustomerHistory_DoWork(sender As Object, e As ComponentModel.DoWorkEventArgs)
        Try
            Dim c As New CustomerHistory
    ...
    Public Sub lvSales_SelectedIndexChanged(sender As Object, e As EventArgs)
        '' 
...
Dim x As New SubForm_Launcher(sender)
    ...
    Private Sub SetAppointmentToolStripMenuItem_MouseEnter(sender As Object, e As EventArgs)
        SetAppointmentToolStripMenuItem_Click(Nothing, Nothing)

    End Sub

    Private Sub SetAppointmentToolStripMenuItem1_Click(sender As Object, e As EventArgs)
        Me.btnSetAppt_Click(Me.btnSetAppt, Nothing)
    End Sub

    Private Sub MoveAppointmentToolStripMenuItem_Click(sender As Object, e As EventArgs)
